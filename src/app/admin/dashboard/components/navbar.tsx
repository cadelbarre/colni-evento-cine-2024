...
export default function Navbar({
  ...
  return (
    <nav
      className={twMerge(
        "h-20 border-r bg-white space-y-8 mt-8 md:mt-4 lg:mt-0 mb-4 md:mb-2 lg:mb-0",
        className,
      )}
    >
      <div className="flex flex-row h-full items-center justify-between px-4">
        <div className=" h-20 flex items-center pl-2">
          <div className="w-full flex flex-col lg:flex-row items-center gap-x-4">
            <img
          ...
          <ul className="flex text-sm font-medium gap-x-2">
            {navigation.map((item) => (
              <li key={item.name}>
                <button
                  type="button"
                  className="flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-violet-50 active:bg-gray-100 duration-150 text-xs md:text-base border border-violet-600"
                >
            ...
            <li onKeyDown={logout}>
              <button
                type="button"
                className="w-full flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-violet-50 active:bg-gray-100 duration-150 border border-violet-600"
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-xs md:text-sm lg:text-base text-left">
                  Cerrar Sesion
                </span>
              </button>
            </li>
