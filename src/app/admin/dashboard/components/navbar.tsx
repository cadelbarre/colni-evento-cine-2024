...
export default function Navbar ({ className }: { className: string }): JSX.Element {
  ...
  return (
    <nav
      className={twMerge('w-full h-screen border-r bg-white space-y-8', className)}
    >
      <div className='flex flex-col h-full px-4'>
        ...
        <div className='h-20 flex items-center pl-2'>
          <div className='w-full flex items-center gap-x-4'>
            <img
              src='../assets/kelly-llorente.webp'
        ...
        <div className='overflow-auto mt-4'>
          ...
          <div className='pt-2 mt-2 border-t'>
            <ul className='text-sm font-medium'>
              <li onClick={logout}>
                <a href='#' className='flex items-center gap-x-2 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150'>
