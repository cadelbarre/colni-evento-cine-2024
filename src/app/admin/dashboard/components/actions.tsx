      ...
      if (willDelete) {
        ...
        await swal(
          ...
          action === "edit"
            ...
            : "El ususario ha sido eliminado correctamente",
          "success",
        );
      }
    });
    ...
    <Menu>
      ...
      >
        <MenuItem>
          <button
            type="button"
            onClick={async () => await sendEmail(user)}
            className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-blue-100"
          >
        ...
        <MenuItem>
          <button
            type="button"
            onClick={async () => await showWarning("edit")}
            className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-blue-100"
          >
            <PencilIcon className="size-4 fill-gray-600" />
            Pagó
        ...
        <MenuItem>
          <button
            type="button"
            onClick={async () => await showWarning("delete")}
            className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-rose-500 hover:text-white group"
          >
